...
const ResultInfo = (props: ResultInfoProps) => {
	...
	const counter = useCounter({ value: props.result, time: 70 })
	...
	return (
		<div className='text-center max-w-2xl px-24 pt-10 pb-16 rounded-b-[3rem] rounded-b-3xl  bg-gradient-to-b from-lightSlateBlueBbackground to-lightRoyalBlueBackground overflow-hidden md:w-[37rem] md:pt-14 md:pb-20 md:rounded-[3rem]'>
